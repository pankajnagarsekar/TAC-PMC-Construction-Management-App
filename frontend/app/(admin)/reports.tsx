...
const styles = StyleSheet.create({
  ...
  workersReportInfo: { flex: 1 },
  workersReportTitle: { fontSize: FontSizes.md, fontWeight: '600', color: Colors.text },
  workersReportDesc: { fontSize: FontSizes.sm, color: Colors.textMuted, marginTop: 2 },
  reportCard: {
    backgroundColor: Colors.white,
    borderRadius: BorderRadius.lg,
    padding: Spacing.md,
