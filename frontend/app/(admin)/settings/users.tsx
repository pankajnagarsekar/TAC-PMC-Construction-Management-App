...
const styles = StyleSheet.create({
  ...
  projectGrid: { marginTop: Spacing.sm, maxHeight: 200 },
  projectItem: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, paddingVertical: Spacing.sm, paddingHorizontal: Spacing.sm, borderRadius: BorderRadius.md, marginBottom: 4, backgroundColor: Colors.background },
  projectItemActive: { backgroundColor: Colors.accent + '15', borderWidth: 1, borderColor: Colors.accent + '30' },
  projectItemInfo: { flex: 1 },
  projectItemName: { fontSize: FontSizes.sm, color: Colors.text },
  projectItemNameActive: { color: Colors.accent, fontWeight: '500' },
  projectItemCode: { fontSize: FontSizes.xs, color: Colors.textMuted },
  noProjectsContainer: { alignItems: 'center', padding: Spacing.lg, backgroundColor: Colors.background, borderRadius: BorderRadius.md, marginTop: Spacing.sm },
  noProjectsText: { fontSize: FontSizes.sm, color: Colors.textMuted, marginTop: Spacing.xs },
  selectedCountText: { fontSize: FontSizes.xs, color: Colors.accent, fontWeight: '600', marginTop: Spacing.sm, textAlign: 'right' },
